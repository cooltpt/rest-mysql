...
function rest_table_wrap(serverCtx, router, pool, table_name, md5) {
   ...
   pool.getConnection().then((conn) => {
      ...
      metaData = rs[0];
      logger.info("rest_table_wrap setup for " + table_name + " is..\n\t" + JSON.stringify(metaData));
      ...
      logger.error("rest_table_wrap setup for " + table_name + " has errors\n\t" + JSON.stringify(err));
      return;
   ...
   router.get("/" + table_name + "/:id", function (req, res) {
   ...
   router.post("/" + table_name, function (req, res) {
   ...
   router.put("/" + table_name, function (req, res) {
   ...
   router.delete("/" + table_name, function (req, res) {
   ...
   router.delete("/" + table_name + "/:id", function (req, res) {
